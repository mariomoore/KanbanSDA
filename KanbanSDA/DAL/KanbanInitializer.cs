...
namespace KanbanSDA.DAL
{
    public class KanbanInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<KanbanContext>
    {
        ...
        protected override void Seed(KanbanContext context)
        {
            ...
            {
                new Project{Id=1, Name="Project 1", Description="First project", BoardId=1},
                new Project{Id=2, Name="Project 2", Description="Second project", BoardId=2}
            };
            ...
            var issues = new List<Issue>
            {
                ...
                new Issue{Id=3, Name="Zadanie 3", Description="Opis zadania 3", ColumnId=3, CreatedDate=DateTime.UtcNow, UpdatedDate=DateTime.UtcNow},
                new Issue{Id=4, Name="Zadanie 4", Description="Opis zadania 4", ColumnId=4, CreatedDate=DateTime.UtcNow, UpdatedDate=DateTime.UtcNow},
                new Issue{Id=5, Name="Zadanie 5", Description="Opis zadania 5", ColumnId=5, CreatedDate=DateTime.UtcNow, UpdatedDate=DateTime.UtcNow},
                new Issue{Id=6, Name="Zadanie 6", Description="Opis zadania 6", ColumnId=6, CreatedDate=DateTime.UtcNow, UpdatedDate=DateTime.UtcNow}
            };
